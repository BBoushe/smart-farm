...
export const listings: Listing[] = [
  // Equipment listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=John+Deere+Tractor",
      "/placeholder.svg?height=300&width=400&text=Tractor+Side+View",
      "/placeholder.svg?height=300&width=400&text=Tractor+Interior",
    ],
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Case+Harvester",
      "/placeholder.svg?height=300&width=400&text=Harvester+Header",
      "/placeholder.svg?height=300&width=400&text=Grain+Tank",
    ],
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Massey+Ferguson",
      "/placeholder.svg?height=300&width=400&text=GPS+System",
      "/placeholder.svg?height=300&width=400&text=Tractor+Cabin",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Kubota+Tractor",
      "/placeholder.svg?height=300&width=400&text=Utility+Work",
    ],
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Disc+Harrow",
      "/placeholder.svg?height=300&width=400&text=Field+Work",
    ],
    contactInfo: "+381 60 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=New+Holland+Tractor",
      "/placeholder.svg?height=300&width=400&text=Modern+Cabin",
    ],
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Fendt+Tractor",
      "/placeholder.svg?height=300&width=400&text=Vario+Transmission",
    ],
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Claas+Combine",
      "/placeholder.svg?height=300&width=400&text=Grain+Header",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  // Product listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Organic+Potatoes",
      "/placeholder.svg?height=300&width=400&text=Potato+Quality",
      "/placeholder.svg?height=300&width=400&text=Harvest+Fresh",
    ],
    contactInfo: "+381 60 345 6789",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Organic+Tomatoes",
      "/placeholder.svg?height=300&width=400&text=Tomato+Harvest",
      "/placeholder.svg?height=300&width=400&text=Fresh+Tomatoes",
    ],
    contactInfo: "+381 60 345 6789",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Sunflower+Seeds",
      "/placeholder.svg?height=300&width=400&text=Quality+Seeds",
    ],
    contactInfo: "+381 60 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Organic+Flour",
      "/placeholder.svg?height=300&width=400&text=Stone+Ground",
    ],
    contactInfo: "+381 60 456 7890",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Olive+Oil",
      "/placeholder.svg?height=300&width=400&text=Croatian+Olives",
    ],
    contactInfo: "+385 91 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Corn+Feed",
      "/placeholder.svg?height=300&width=400&text=Livestock+Feed",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  // Service listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Soil+Testing",
      "/placeholder.svg?height=300&width=400&text=Lab+Analysis",
      "/placeholder.svg?height=300&width=400&text=Soil+Report",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Crop+Spraying",
      "/placeholder.svg?height=300&width=400&text=Spray+Equipment",
    ],
    contactInfo: "+381 60 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Agricultural+Consulting",
      "/placeholder.svg?height=300&width=400&text=Farm+Planning",
    ],
    contactInfo: "+381 60 456 7890",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Greenhouse+Construction",
      "/placeholder.svg?height=300&width=400&text=Modern+Greenhouse",
    ],
    contactInfo: "+381 60 345 6789",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Vineyard+Management",
      "/placeholder.svg?height=300&width=400&text=Wine+Grapes",
    ],
    contactInfo: "+385 91 234 5678",
  ...
  // Additional rental listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Seed+Drill",
      "/placeholder.svg?height=300&width=400&text=Precision+Planting",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Hay+Baler",
      "/placeholder.svg?height=300&width=400&text=Round+Bales",
    ],
    contactInfo: "+381 60 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Cultivator",
      "/placeholder.svg?height=300&width=400&text=Soil+Preparation",
    ],
    contactInfo: "+381 60 456 7890",
  ...
  // More equipment listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Zetor+Tractor",
      "/placeholder.svg?height=300&width=400&text=Comfortable+Cabin",
    ],
    contactInfo: "+381 60 345 6789",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Vineyard+Tractor",
      "/placeholder.svg?height=300&width=400&text=Narrow+Design",
    ],
    contactInfo: "+385 91 234 5678",
  ...
  // More product listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Organic+Fertilizer",
      "/placeholder.svg?height=300&width=400&text=Compost+Quality",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Soybean+Seeds",
      "/placeholder.svg?height=300&width=400&text=High+Quality",
    ],
    contactInfo: "+381 60 234 5678",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Fresh+Milk",
      "/placeholder.svg?height=300&width=400&text=Dairy+Farm",
    ],
    contactInfo: "+381 60 456 7890",
  ...
  // More service listings
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Irrigation+System",
      "/placeholder.svg?height=300&width=400&text=Smart+Irrigation",
    ],
    contactInfo: "+381 60 123 4567",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Pest+Control",
      "/placeholder.svg?height=300&width=400&text=Crop+Protection",
    ],
    contactInfo: "+381 60 345 6789",
  ...
  },
  {
    ...
    status: "active",
    images: [
      "/placeholder.svg?height=300&width=400&text=Grain+Storage",
      "/placeholder.svg?height=300&width=400&text=Storage+Facility",
    ],
    contactInfo: "+381 60 234 5678",
...
With proper care and attention, most tomato plants can recover from stress and continue producing healthy fruit throughout the growing season.`,
    ...
    images: [
      "/placeholder.svg?height=300&width=400&text=Tomato+Plant+Care",
      "/placeholder.svg?height=300&width=400&text=Healthy+Tomatoes",
    ],
    isAdminPost: false,
    tipAmount: 45.5,
    tipCount: 12,
...
Following this maintenance schedule will extend your tractor's life and ensure reliable operation when you need it most.`,
    ...
    images: [
      "/placeholder.svg?height=300&width=400&text=Tractor+Maintenance",
      "/placeholder.svg?height=300&width=400&text=Engine+Service",
    ],
    isAdminPost: true,
    tipAmount: 0,
    tipCount: 0,
...
With proper management, sunflower yields of 2,000-3,000 lbs/acre are achievable in our region.`,
    ...
    images: [
      "/placeholder.svg?height=300&width=400&text=Sunflower+Field",
      "/placeholder.svg?height=300&width=400&text=Sunflower+Harvest",
    ],
    isAdminPost: false,
    tipAmount: 32.0,
    tipCount: 8,
...
Small farms can be highly profitable with the right approach and dedication to continuous improvement.`,
    ...
    images: [
      "/placeholder.svg?height=300&width=400&text=Small+Farm",
      "/placeholder.svg?height=300&width=400&text=Farm+Business",
    ],
    isAdminPost: false,
    tipAmount: 28.5,
    tipCount: 6,
...
The organic market continues to grow, making certification a valuable investment for many farmers.`,
    ...
    images: [
      "/placeholder.svg?height=300&width=400&text=Organic+Certification",
      "/placeholder.svg?height=300&width=400&text=Organic+Farm",
    ],
    isAdminPost: false,
    tipAmount: 41.0,
    tipCount: 9,
